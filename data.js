const rawKeys = ['granum', 'calx', 'saburra', 'tephra'];
const defaultPrices = { granum: 15, calx: 35, saburra: 15, tephra: 50 };

const CATEGORIES = [
    { id: 'raw', items: ['granum', 'calx', 'saburra', 'tephra', 'water'] },
    { id: 'catalyst', items: ['coal', 'coke', 'sp', 'cp', 'fumingsalt'] },
...
const RECIPES = {
    ...
    cuprum: { type: 'smelt', ore: 'malachite', oreYield: 0.40, cat: 'coal', catReq: 0.05 },
